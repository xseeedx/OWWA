  ...
  <div class="row">
          ...
          <div class="col-sm-3"><!--left col-->
            ...
            <!--    <a href="" data-target="#myModal"  data-toggle="modal" > 
                <img title="profile image" width="223" height="250" src="">  
              </a> --> 
                <img title="profile image" width="100%" height="40%" src="<?php echo web_root.'scholar/modules/modstudent/'.$singlestudent->PROIMAGE ?>">   
              </div>
            <ul class="list-group">
