  ...
  <ul class="nav">
    <li class="nav-item <?php echo (currentpage_admin() == '') ? 'active' : ''; ?>">
    ...
    <li class="nav-item <?php echo (currentpage_admin() == 'announcement') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo web_root; ?>admin/modules/announcement/index.php">
        <p>Announcements</p>
      </a>
    </li>

    <li class="nav-item <?php echo (currentpage_admin() == 'modstudent') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo web_root; ?>admin/modules/modstudent/index.php">
        <p>Scholar</p>
      </a>
    </li>
    <li class="nav-item <?php echo (currentpage_admin() == 'user') ? 'active' : ''; ?>">
    ...
    <li class="nav-item <?php echo (currentpage_admin() == 'notification') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo web_root; ?>admin/modules/notification/index.php">
      <?php
 $mydb->setQuery("SELECT count(*) as count FROM `notification` where notification_status not in('read') AND notification_for = 'Administrator'");
...
//  print_r($cur[0]->count);
    ...
    <div class="dropdown">
      <li class="nav-item  <?php echo (currentpage_admin() == 'reports') ? 'active' : ''; ?>" >
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
          <li><a class="dropdown-item" href="<?php echo web_root; ?>admin/modules/reports/List_of_scholar/index.php">Scholar List</a></li>
          <li><a class="dropdown-item" href="<?php echo web_root; ?>admin/modules/reports/Grant_List/index.php">Grant List</a></li>
          <li><a class="dropdown-item" href="<?php echo web_root; ?>admin/modules/reports/Graduated_List/index.php">Graduate Scholar</a></li>
          <li><a class="dropdown-item" href="<?php echo web_root; ?>admin/modules/reports/Submitted_documents/index.php">Submitted Documents</a></li>
          <li><a class="dropdown-item" href="<?php echo web_root; ?>admin/modules/reports/Terminated/index.php">Terminated Scholar</a></li>
        </ul>
      </li>
    </div>
  </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid" Style="margin-top:0">
            ...
            <div class="collapse navbar-collapse justify-content-end"> 
              ...
              <!-- <a href="<?php echo web_root; ?>admin/modules/notification/index.php">
    <span class="badge rounded-pill badge-notification bg-danger text-white"><?php echo (!empty($cur[0])) ? $cur[0]->count : ""; ?></span>
    <a>             -->
    <a href="<?php echo web_root; ?>admin/modules/notification/index.php">
