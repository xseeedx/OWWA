...
if (isset($_GET['file_id'])) {
    ...
    if ($file) {
        ...
        header('Content-Disposition: attachment; filename="' . $file->document_name . '"');
        header('Expires: 0');
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../uploads/' . $file->document_name)); // Replace this with your actual file path
