	...
	<div class="row">
		<div class="col-lg-12"> 
			<!-- Pachange nalang ng name ng php into reports.php yung department -->
				<h3  >Submitted Documents<small></small></h3> 
				...
				<tbody>
						<?php 
							$query = "SELECT * FROM `upload_documents` INNER JOIN `scholar_info` WHERE upload_documents.report_sender=scholar_info.user_id";
							$mydb->setQuery($query);
