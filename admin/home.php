                    ...
                    <div class="inner">
                        <div class="fonts">
                            ...
                            <h3><?php
                                ...
                                $query = "SELECT COUNT(*) as total FROM scholar_info WHERE `graduate` != 'yes'";
            ...
            <div class="col-lg-3 col-6 mb-3">
                ...
                <div class="green">
                    <div class="p-2 bg-success rounded-3" style="height: 70px">
                        <div class="inner">
                            <h3>                        <?php 
                        $query = "SELECT COUNT(*) as total FROM scholar_info where program LIKE 'ODSP' AND `graduate` != 'yes'";
                                $result = mysqli_query($connection, $query);
                ...
                <div class="yellow">
                    <div class="p-2 bg-warning rounded-3" style="height: 70px">
                        <div class="inner">
                            <div class="fonts">
                                <h3><?php 
                        $query = "SELECT COUNT(*) as total FROM scholar_info where program LIKE 'EDSP' AND `graduate` != 'yes'";
                                $result = mysqli_query($connection, $query);
                ...
                <div class="p-2 bg-danger rounded-3" style="height: 160px">
                    <div class="inner">
                        ...
                        <h3>                        
                            <?php
                                $query = "SELECT COUNT(*) as total FROM scholar_info where program LIKE 'ELAP%' AND `graduate` != 'yes'";
                                $result = mysqli_query($connection, $query);
